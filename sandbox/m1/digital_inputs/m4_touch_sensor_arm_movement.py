...
def arm_calibration(arm_motor, touch_sensor):
    ...
    """
    # : 3. Implement the arm calibration movement by fixing the code below (it has many bugs).  It should to this:
...
def arm_down(arm_motor):
    ...
    # : 6. After you fix the bugs in the three arm movement commands demo your code to a TA or instructor.
    #
