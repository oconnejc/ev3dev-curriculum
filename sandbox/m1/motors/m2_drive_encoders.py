...
# : 6. Formally test your work. When you think you have the problem complete run these tests:
...
def main():
    ...
    while position_sp != 0:
        left_sp = speed_sp
        right_sp = speed_sp
        left_motor.run_to_rel_pos(speed_sp=left_sp,position_sp=position_sp,stop_action=stop_action)
        right_motor.run_to_rel_pos(speed_sp=right_sp,position_sp=position_sp,stop_action=stop_action)
